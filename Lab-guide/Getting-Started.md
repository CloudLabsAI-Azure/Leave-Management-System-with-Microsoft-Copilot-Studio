...
**Leave Management System with Microsoft Copilot Studio** ラボへようこそ！このラボでは、インテリジェントな休暇管理エージェントを構築、設定、テストする方法を学習するためのシームレスな環境を準備しました。このラボでは、ビジネス ルールの適用、承認の処理、Dataverse との統合について説明し、安全で効率的なエクスペリエンスを提供します。
...
1. Power Apps ポータルで、左側のメニューから **[テーブル] (1)** を選択し、**[データベースの作成] (2)** を選択します。

   ![](../media/ex3img71.png)

   >**注:** **[データベースの作成]** オプションが表示されず、既にいくつかのテーブルが表示されている場合は、**手順 10** から続行してください。

1. 新しいデータベースを作成するためのウィンドウで、**[マイ データベースの作成]** を選択します。

   ![](../media/ex3img72up.png)

1. 完了したら、**[Excel または .CSV ファイルで作成]** を選択します。
...
1. **[ビジネス ユニット]** の下で、検索ボックスに **org (1)** と入力し、リストから利用可能なビジネス ユニットを選択 **(2)** します。
